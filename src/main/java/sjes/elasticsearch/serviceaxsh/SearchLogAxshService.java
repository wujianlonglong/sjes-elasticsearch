...
import sjes.elasticsearch.repositoryaxsh.SearchLogAxshRepository;
 ...
 */
@Service("searchLogAxshService")
public class SearchLogAxshService {

    private final static int MAX_HOTWORDS_COUNT = 5;    //能够获取的热门搜索记录的最大数量

    private static Logger LOGGER = LoggerFactory.getLogger(SearchLogAxshService.class);

    @Autowired
    private SearchLogAxshRepository searchLogAxshRepository;
    ...
    public void index(String keyword, Long categoryId, String shopId, String sortType, Double startPrice, Double endPrice, String userAgent, String ip) throws ServiceException {
        if (StringUtils.isNotBlank(keyword) && !isMessyCode(keyword)) {
            SearchLogModelAxsh searchLogModel = new SearchLogModelAxsh();
            ...
            searchLogAxshRepository.save(searchLogModel);
        }
    }
    ...
    public void deleteAll() {
        searchLogAxshRepository.deleteAll();
    }
    ...
    public List<HotWordModel> getHotWords(Integer maxCount) throws ServiceException {
        ...
        SearchQuery searchQuery = new NativeSearchQueryBuilder()
                ...
                .withIndices("logstash-axsh").withTypes("searchlog")
