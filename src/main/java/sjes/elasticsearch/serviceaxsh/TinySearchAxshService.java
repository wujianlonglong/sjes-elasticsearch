 ...
 */
@Service("tinySearchAxshService")
public class TinySearchAxshService {

    private static Logger LOGGER = LoggerFactory.getLogger(TinySearchAxshService.class);
    ...
    public PageModel getProducts(Long id, String keyword, Integer saleType, Integer page, Integer size) {
        ...
        FacetedPage<ProductIndexAxsh> facetedPage = productIndexAxshRepository.search(nativeSearchQueryBuilder.withPageable(new PageRequest(pageable.getPage(), pageable.getSize())).build());
